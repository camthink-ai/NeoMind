    ...
    serde_json::from_value(json!({
        ...
        "downlink": {
            "commands": [
                {
                    "name": "set_interval",
                    "display_name": "Set Report Interval",
                    "parameters": [
                        {
                            "name": "interval",
    ...
    serde_json::from_value(json!({
        ...
        "downlink": {
            "commands": [
                {
                    "name": "reset_energy",
                    "display_name": "Reset Energy",
                    "parameters": []
                },
                {
                    "name": "set_alarm",
                    "display_name": "Set Alert",
                    "parameters": [
                        {
                            "name": "type",
        ...
        "downlink": {
            "commands": [
                ...
                },
                {
                    ...
                    "display_name": "Enable Motion Detection",
                    "parameters": [
                        {
                            "name": "enabled",
                            "display_name": "Enable",
            ...
            "commands": [
                {
                    ...
                    "display_name": "Trigger Capture",
                    "parameters": []
                },
                {
                    "name": "set_interval",
                    "display_name": "Set Scheduled Capture",
                    "parameters": [
                        {
                            "name": "interval",
                            "display_name": "Interval",
