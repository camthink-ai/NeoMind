...
fn convert_metric_value(value: MetricValue) -> neomind_core::MetricValue {
    use serde_json::json;
    match value {
        MetricValue::Integer(v) => neomind_core::MetricValue::Integer(v),
        MetricValue::Float(v) => neomind_core::MetricValue::Float(v),
        MetricValue::String(v) => neomind_core::MetricValue::String(v),
