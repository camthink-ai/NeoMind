...
use edge_ai_llm::backends::ollama::{OllamaConfig, OllamaRuntime};
use edge_ai_core::llm::backend::{LlmInput, LlmRuntime};
use edge_ai_core::message::{Message, MessageRole, Content, ContentPart};
...
async fn test_multimodal_with_tools() {
    ...
    let tools = vec![edge_ai_core::llm::backend::ToolDefinition {
