...
impl From<Arc<edge_ai_commands::command::CommandRequest>> for CommandDto {
    fn from(cmd: Arc<edge_ai_commands::command::CommandRequest>) -> Self {
        Self {
            id: cmd.id.clone(),
...
impl From<&edge_ai_commands::command::CommandResult> for CommandResultDto {
    fn from(result: &edge_ai_commands::command::CommandResult) -> Self {
        Self {
...
pub async fn list_commands_handler(
    ...
    let mut all_commands: Vec<edge_ai_commands::command::CommandRequest> = Vec::new();
    for status in [
        edge_ai_commands::command::CommandStatus::Pending,
        edge_ai_commands::command::CommandStatus::Queued,
        edge_ai_commands::command::CommandStatus::Sending,
        edge_ai_commands::command::CommandStatus::WaitingAck,
        edge_ai_commands::command::CommandStatus::Completed,
        edge_ai_commands::command::CommandStatus::Failed,
        edge_ai_commands::command::CommandStatus::Cancelled,
        edge_ai_commands::command::CommandStatus::Timeout,
    ] {
