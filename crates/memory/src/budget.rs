...
//!
//! ```rust,no_run
//! use edge_ai_memory::{TokenBudget, ScoredMessage, Priority, PriorityFilter};
...
use edge_ai_core::llm::token_counter::TokenCounter;
...
impl TokenBudget {
    ...
    /// # Example
    /// ```
    /// use edge_ai_memory::TokenBudget;
    ///
    /// let budget = TokenBudget::new(8000, 2000, 500);
...
mod tests {
    use super::*;
    use edge_ai_core::llm::token_counter::CounterMode;
