...
pub struct MessageManager {
    ...
    storage: Arc<RwLock<Option<Arc<edge_ai_storage::MessageStore>>>>,
...
impl MessageManager {
    ...
    pub fn with_storage<P: AsRef<Path>>(data_dir: P) -> Result<Self> {
        ...
        let store = Arc::new(
            edge_ai_storage::MessageStore::open(data_dir)
    ...
    fn stored_to_message(stored: edge_ai_storage::StoredMessage) -> Message {
        Message {
    ...
    fn message_to_stored(msg: &Message) -> edge_ai_storage::StoredMessage {
        edge_ai_storage::StoredMessage {
            id: msg.id.to_string(),
    ...
    pub async fn set_event_bus(&self, event_bus: Arc<edge_ai_core::EventBus>) {
