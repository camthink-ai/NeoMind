...
export const componentRegistry: ComponentRegistry = {
  ...
  'tabs': {
    ...
    category: 'layout',
    icon: LayoutIcon,
    sizeConstraints: getSizeConstraints('tabs'),
    hasDataSource: false,
    hasDisplayConfig: true,
    hasActions: false,
    acceptsProp: (prop) => [
      'tabs', 'defaultTab', 'variant', 'position', 'className'
    ].includes(prop),
    defaultProps: {
      variant: 'default',
      position: 'top',
    },
    variants: ['default', 'enclosed', 'soft'],
  },
  ...
  'heading': {
    ...
    category: 'layout',
    icon: HeadingIcon,
    sizeConstraints: getSizeConstraints('heading'),
    hasDataSource: false,
    hasDisplayConfig: true,
    hasActions: false,
    acceptsProp: (prop) => [
      'text', 'level', 'align', 'variant', 'className'
    ].includes(prop),
    defaultProps: {
      level: 3,
      align: 'left',
  ...
  'alert-banner': {
    ...
    category: 'layout',
    icon: AlertTriangle,
    sizeConstraints: getSizeConstraints('alert-banner'),
    hasDataSource: false,
    hasDisplayConfig: true,
    hasActions: false,
    acceptsProp: (prop) => [
      'title', 'message', 'variant', 'dismissible', 'className'
    ].includes(prop),
    defaultProps: {
      variant: 'info',
      dismissible: true,
